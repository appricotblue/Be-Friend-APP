import { View, Text, StyleSheet, Image, TouchableOpacity, ImageBackground, DrawerLayoutAndroid } from 'react-native';
...
const ProfileScreen = ({ navigation }) => {
    ...
    const renderDrawerContent = () => (
        <View style={styles.drawerContainer}>
            <Text style={{ color: 'white', fontSize: 20, marginBottom: 20, marginLeft: 10, marginTop: 15 }}>Settings</Text>
            {drawerItems.map((item) => (
                <TouchableOpacity key={item.id} onPress={() => handleDrawerItemPress(item.id)} style={styles.drawerItemContainer}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.itemContainer}>
                    ...
                    <LinearGradient colors={['#41295A', '#2F0743']} style={styles.item}>
                        ...
                        <TouchableOpacity onPress={() => { setSelected(!selected); changeLanguage(selected ? 'en' : 'ml'); }}>
                            <LinearGradient colors={['#EC008C', '#FC6767']} style={styles.languageSwitch}>
                                <Text style={styles.languageText}>{selected ? 'english' : 'malayalam'}</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </LinearGradient>
                    <LinearGradient colors={['#41295A', '#2F0743']} style={styles.item}>
