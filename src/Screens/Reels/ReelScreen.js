  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={{ width: '97%', flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center' }}>
          <Text style={{ fontSize: 18, color: 'white', fontFamily: 'Livvic-BoldItalic' }}>Private Callyyy</Text>
          <Text style={{ fontSize: 16, color: 'white', fontFamily: 'Livvic-BoldItalic' }}>View All</Text>
        </View>
